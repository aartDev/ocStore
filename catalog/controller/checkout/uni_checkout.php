...
class ControllerCheckoutUniCheckout extends Controller { 	
	public function index() {
		...
		$data['show_popup_login'] = isset($uniset['show_login']) && !$this->customer->isLogged() ? true : false;
		...
		$data['checkout_goal_id'] = isset($uniset['checkout_metric_id']) ? $uniset['checkout_metric_id'] : 0;
	...
	public function validate() {
		...
		if (!$json) {
			...
			$json['success']['order_payment'] = $this->load->controller('extension/payment/'.$payment);
		}
	...
	public function cart(){
		...
		$data['entry_reward'] = sprintf($this->language->get('entry_reward'), $points, $points_total);
