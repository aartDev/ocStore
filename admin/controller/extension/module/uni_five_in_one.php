...
class ControllerExtensionModuleUniFiveInOne extends Controller {
	...
	public function index() {
		...
		foreach($data['stores'] as $store) {
			$data['tab_name'][$store['store_id']] = ['latest' => $this->language->get('entry_tab_latest'), 'special' => $this->language->get('entry_tab_special'), 'popular' => $this->language->get('entry_tab_popular'), 'bestseller' => $this->language->get('entry_tab_bestseller'), 'featured' => $this->language->get('entry_tab_featured')];
		}
